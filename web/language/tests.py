...
class LanguageAPITests(APITestCase):
    ...
    def test_language_detail(self):
        ...
        response = self.client.get(
            "/api/language/{}/".format(self.language.id), format="json"
        )
    ...
    def test_create_membership(self):
        ...
        response = self.client.post(
            "/api/languagemember/",
            {"user": {"id": self.user.id}, "language": {"id": self.language.id}},
            format="json",
        )
        self.assertEqual(response.status_code, status.HTTP_200_OK)
...
class CommunityAPITests(APITestCase):
    ...
    def test_verify_membership(self):
        ...
        response_get = self.client.post(
            "/api/communitymember/verify_membership/",
            {"user": {"id": self.user.id}, "community": {"id": self.community.id}},
            format="json",
        )
...
class PlaceNameAPITests(APITestCase):
    ...
    def test_placename_detail(self):
        ...
        """
        response = self.client.get(
            "/api/placename/{}/".format(self.placename.id), format="json"
        )
        self.assertEqual(response.status_code, status.HTTP_200_OK)
...
class MediaFavouriteAPITests(APITestCase):
    def setUp(self):
        ...
        self.mediafavourite = MediaFavourite.objects.create(
    ...
    def test_mediafavourite_detail(self):
        ...
        """
        response = self.client.get(
            "/api/mediafavourite/{}/".format(self.mediafavourite.id), format="json"
        )
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_mediafavourite_delete(self):
        ...
        """
        response = self.client.delete(
            "/api/mediafavourite/", {"id": self.mediafavourite.id}, format="json"
        )
        self.assertEqual(response.status_code, status.HTTP_200_OK)
